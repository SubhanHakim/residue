            ...
            <div className="max-w-4xl mx-auto space-y-8 relative z-20">
                ...
                <div ref={buttonsRef} className="flex flex-col items-center gap-8">
                    ...
                    <div className="flex items-center gap-6 text-gray-400">
                        ...
                        <a href="https://pump.fun/coin/7BC6z3ggqcs6dQkqzrhTELMSQ2pKQt6izU76s3k9pump" className="p-2 hover:text-white transition-colors hover:scale-110 transform duration-200">
